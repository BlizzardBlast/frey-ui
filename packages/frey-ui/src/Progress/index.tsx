...
type ProgressComponent = React.ForwardRefExoticComponent<
  Readonly<ProgressProps> & React.RefAttributes<HTMLDivElement>
>;
...
const Progress: ProgressComponent = React.forwardRef<
  HTMLDivElement,
...
>(function Progress(
  ...
  return (
    ...
    >
      ...
      <div className={clsx(styles.progress_track_wrapper, SizeClassMap[size])}>
        <progress
          className={clsx(
